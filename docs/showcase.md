...
- **Primary "try it" link:** the live Vercel URL (the web build _is_ the product,
...
>
> The interesting part wasn't the UI, it was making it _real_:
...
> • Daily Anchor score + AI-ready reflection workflow: structured day signals
> become a calm review, with a signed-in API route ready for OpenAI structured
> outputs.
